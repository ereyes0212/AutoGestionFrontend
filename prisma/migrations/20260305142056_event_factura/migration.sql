...
-- AddForeignKey
ALTER TABLE `EventoFactura` ADD CONSTRAINT `EventoFactura_empleadoId_fkey` FOREIGN KEY (`empleadoId`) REFERENCES `Empleados`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `EventoFactura` ADD CONSTRAINT `EventoFactura_notaId_fkey` FOREIGN KEY (`notaId`) REFERENCES `Nota`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `EventoFacturaArchivo` ADD CONSTRAINT `EventoFacturaArchivo_eventoFacturaId_fkey` FOREIGN KEY (`eventoFacturaId`) REFERENCES `EventoFactura`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
